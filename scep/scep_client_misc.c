 ...
 * @param[in] param Pointer to the SCEP client context
 * @return Error code
 **/

error_t scepClientInitTlsContext(HttpClientContext *httpClientContext,
   TlsContext *tlsContext, void *param)
{
   error_t error;
   ScepClientContext *context;

   //Point to the SCEP client context
   context = (ScepClientContext *) param;
